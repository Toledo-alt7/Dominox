...
public class FaseRegistry {
    ...
    //guarda o histórico das partidas jogadas
    private static final List<GameEngine> historicoPartidas = new ArrayList<>();

    public static void salvarPartidaFinalizada(GameEngine engine) {
        historicoPartidas.add(engine);
    }

    public static List<GameEngine> getHistoricoPartidas() {
